...
import { MiniProfilerDialogHostComponent } from '../dialog-host/dialog-host.component';
import { MiniProfilerDialogComponent } from '../dialog/dialog.component';
...
const meta: Meta = {
  title: 'MiniProfilerTimingsComponent',
  component: MiniProfilerTimingsComponent,
  decorators: [
    moduleMetadata({
      declarations: [
...
type Story = StoryObj<MiniProfilerTimingsComponent>;
...
export const DefaultQueryDialogUI: Story = {
  render: (args) => ({
    props: args,
    template: `
      <ht-miniprofiler-timings [result]="result"></ht-miniprofiler-timings>
      <ht-dialog-host></ht-dialog-host>
    `,
    applicationConfig: {
      providers: [
        provideMiniProfilerConfig({
...
export const AlternativeQueryDialogUI: Story = {
  render: (args) => ({
    props: args,
    template: `
      <ht-miniprofiler-timings [result]="result"></ht-miniprofiler-timings>
