 ...
 */
export interface NgxMiniProfilerDefaultOptions {
  api: string;
  path: string;
  authorized: boolean;
  version: string;
 ...
 */
export const NGX_MINIPROFILER_DEFAULT_OPTIONS = new InjectionToken<NgxMiniProfilerDefaultOptions>(
...
export function NGX_MINIPROFILER_DEFAULT_OPTIONS_FACTORY(): NgxMiniProfilerDefaultOptions {
  return {
    api: '/profiler',
    path: '/profiler',
    authorized: true,
