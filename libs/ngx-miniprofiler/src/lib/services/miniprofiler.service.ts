...
export class MiniProfilerService {
  ...
  private selectedDataSource = new BehaviorSubject<string | null>(null);
   ...
   */
  public selectProfileResult(id: string | null): void {
  ...
  private processProfileResult(profiler: IProfiler): IProfiler {
    ...
    this.processTiming(result, result.Root, undefined, 0);
